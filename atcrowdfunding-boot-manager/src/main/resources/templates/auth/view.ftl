    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container-fluid">
        <div class="navbar-header">
          <div><a class="navbar-brand" style="font-size:32px;" href="#">众筹平台 - 实名认证审批</a></div>
        </div>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			<div class="panel panel-default">
			  <div class="panel-heading">
				<h3 class="panel-title"><i class="glyphicon glyphicon-th"></i> 审核会员信息</h3>
			  </div>
			  <div class="panel-body">
					真实姓名：${Request.member.realname} <br>
					身份证号：${Request.member.cardnum} <br>
					电话号码：${Request.member.tel} <br>
					<br>
					
					<#list memberCertList as map>
						资质名称：${map.certName}<br>
						资质图片：<br>
							<img src="/pics/cert/${map.iconpath}" /><br><br>
					</#list>
					<br><br>
					<button type="button" onclick="passApply()" class="btn btn-default btn-success">
	...
	<script src="${APP_PATH }/jquery/jquery-form.min.js"></script>
        ...
        <script type="text/javascript">
            $(function () {
				...
				$("#procDefImg").attr("src","${APP_PATH}/process/loadImg/${RequestParameters['pdId']}");
            });

 ...
 <div class="navbar-wrapper">
    ...
    <div class="container theme-showcase" role="main">
      <div class="page-header">
		...
		<form id="certUploadForm" style="margin-top:20px;" action="${APP_PATH}/member/certUpload" method="post" enctype="multipart/form-data">
			<#list certList as cert>
				  <div class="form-group">
					<label for="exampleInputEmail1">${cert.name}</label>
					<input type="hidden" name="memberCertList[${cert_index}].certid" value="${cert.id}"> 
					<input id="" type="file" name="memberCertList[${cert_index}].certFile" class="form-control" >
		            <br>
		...
		function nextStep(){
			$("#certUploadForm").ajaxSubmit({
        		beforeSubmit:function(){
        			loadingIndex = layer.msg('正在上传资质文件，请稍后!', {icon: 16});
        			return true ;
        		},
